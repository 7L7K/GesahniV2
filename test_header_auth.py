...
def test_csrf_bypass():
    ...
    if response.status_code == 401:  # Unauthorized due to invalid token, but CSRF bypassed
...
def main():
    ...
    print("   □ Check backend logs for 'whoami.header_check has_authorization_header=true'")
