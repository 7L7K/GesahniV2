...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "device_id",
            psql.UUID(as_uuid=False),
            sa.ForeignKey("auth.devices.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
        ...
        sa.Column(
            "mfa_passed", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        schema="auth",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "request_count", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        schema="users",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "caregiver_id",
            psql.UUID(as_uuid=False),
            sa.ForeignKey("care.caregivers.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "resident_id",
            psql.UUID(as_uuid=False),
            sa.ForeignKey("care.residents.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "primary_flag",
    ...
    op.create_table(
        ...
        sa.Column(
            "resident_id",
            psql.UUID(as_uuid=False),
            sa.ForeignKey("care.residents.id", ondelete="SET NULL"),
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "alert_id",
            psql.UUID(as_uuid=False),
            sa.ForeignKey("care.alerts.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Time(),
            nullable=False,
            server_default=sa.text("'07:00'::time"),
        ),
        sa.Column(
            "quiet_max_volume",
            sa.Integer(),
    ...
    op.create_table(
        ...
        sa.Column(
            "session_id",
            psql.UUID(as_uuid=False),
            sa.ForeignKey("music.music_sessions.session_id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "session_id",
            psql.UUID(as_uuid=False),
            sa.ForeignKey("auth.sessions.id", ondelete="SET NULL"),
        ),
