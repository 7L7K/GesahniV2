...
class TestResolveSessionId:
    ...
    def test_session_cookie_priority(self):
        ...
        request.cookies = {
            "__session": "sess_1234567890_abcdef12",
            "sid": "cookie_session_456",
        }
    ...
    def test_session_cookie_opaque_validation(self):
        ...
        request.headers = {"X-Session-ID": "header_session_123"}
        request.cookies = {
            "__session": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
        }
    ...
    def test_websocket_session_cookie_priority(self):
        ...
        websocket.headers = {
            "Cookie": "__session=sess_1234567890_abcdef12; sid=cookie_session_456"
        }
    ...
    def test_websocket_session_cookie_opaque_validation(self):
        ...
        websocket.query_params = {"sid": "websocket_session_123"}
        websocket.headers = {
            "Cookie": "__session=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
        }
