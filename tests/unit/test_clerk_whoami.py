...
def test_get_current_user_id_with_clerk(mock_clerk_verify, monkeypatch):
    ...
    monkeypatch.setenv(
        "JWT_SECRET", ""
    )  # No JWT secret so it won't try traditional JWT first
    ...
    mock_request.cookies = {
        "__session": "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyX2NsZXJrXzEyMyIsInVzZXJfaWQiOiJ1c2VyX2NsZXJrXzEyMyIsImVtYWlsIjoidGVzdEBleGFtcGxlLmNvbSJ9.fake_signature"
    }
