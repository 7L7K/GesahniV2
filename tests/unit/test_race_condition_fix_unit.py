...
async def test_claim_refresh_jti_with_retry_success():
    ...
    with patch("app.token_store._get_redis") as mock_get_redis:
        ...
        success, error_reason = await claim_refresh_jti_with_retry(
            "test_sid", "test_jti", 300
        )
...
async def test_claim_refresh_jti_with_retry_concurrent_simulation():
    ...
    with patch("app.token_store._get_redis") as mock_get_redis:
        ...
        success1, error_reason1 = await claim_refresh_jti_with_retry(
            "test_sid", "test_jti", 300
        )
        ...
        success2, error_reason2 = await claim_refresh_jti_with_retry(
            "test_sid", "test_jti2", 300
        )
