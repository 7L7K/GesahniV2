...
@pytest.mark.asyncio
async def test_429_bubbles_retry_after(monkeypatch, async_client, seed_spotify_token):
    ...
    r = await async_client.post("/v1/spotify/play", json={"uris": ["spotify:track:4cOdK2wGLETKBW3PvgPWqT"]})
