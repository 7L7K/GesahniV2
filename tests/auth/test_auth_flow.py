...
def test_refresh_endpoint():
    ...
    try:
        ...
        if response.status_code == 400:
            ...
            print_result(
                "refresh_requires_intent_header",
                False,
    ...
    try:
        ...
        response = requests.post(
            f"{BASE_URL}/v1/auth/refresh", headers=headers, timeout=5
        )
        ...
        if response.status_code == 401:
            ...
            print_result(
                "refresh_returns_401_when_no_token",
                False,
